...
namespace CrossPlatformLibrary.Forms.Controls
{
    ...
    public class ExtendedLabel : Label // TODO: Merge with CustomLabel?!
    {
        ...
        public double CurvedCornerRadius
        {
            get
            {
                return (double)this.GetValue(CurvedCornerRadiusProperty);
            }
            set
            {
                this.SetValue(CurvedCornerRadiusProperty, value);
            }
        }
        ...
        public Color CurvedBackgroundColor
        {
            get
            {
                return (Color)this.GetValue(CurvedBackgroundColorProperty);
            }
            set
            {
                this.SetValue(CurvedBackgroundColorProperty, value);
            }
        }
    }
}